...
console.log(!(true && false)); //true
console.log(false || !false); //false (correction:true)

// Logical Operators and Truthy/Falsy
// ? what do you expect each line to print?
console.log(undefined || null); //null
console.log(!``); //guess was null : correction(true)
console.log(!(1 && "false")); //guess: true |
console.log(NaN || !"true"); //guess: false
...
// let fullMenu = age > 10 ? "full menu" : "kids menu";
