...
// Another example to invoke/console.log the value of the function
let invokedTotal = addNumbersFrom1To100();
console.log(invokedTotal);
// try to print the variable "total" outside the function
// ? what do you expect ?

// total is not defined because we are targeting the global scope but cannot target content in child scope
